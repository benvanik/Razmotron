...
namespace Razmotron
{
	public partial class GL
	{
		...
		public const int GL_POINT_SIZE_ARRAY_OES = 0x8B9C;
		public const int GL_POINT_SIZE_ARRAY_TYPE_OES = 0x898A;
		public const int GL_POINT_SIZE_ARRAY_STRIDE_OES = 0x898B;
		public const int GL_POINT_SIZE_ARRAY_POINTER_OES = 0x898C;
		public const int GL_POINT_SIZE_ARRAY_BUFFER_BINDING_OES = 0x8B9F;

		/* GL_OES_point_sprite */
		public const int GL_POINT_SPRITE_OES = 0x8861;
		public const int GL_COORD_REPLACE_OES = 0x8862;
	}
}
